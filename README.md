...
**Budget App** is an app that built with Ruby on Rails that handle person budget professionally, it helps an individual save there budget items and transactions made under those items.
...
In order to run this project you need: To install Ruby, rails and VS code
...
- gem install rails
- Clone this repository to your desired folder: https://github.com/Koshao-sys/budget-app.git
...
- [ ] **Add features for monthly and Annual budget**
...
Feel free to check the [issues page](https://github.com/Koshao-sys/budget-app/issues).
