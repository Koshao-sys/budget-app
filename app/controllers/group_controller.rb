class GroupController < ApplicationController
  ...
  def create
    ...
    if @transaction.save
      ...
      if @group_categories.save
        redirect_to category_group_index_path(params[:category_id]), notice: 'Successfully created transaction.'
      else
        render :new
      end
    else
  ...
  def destroy
    ...
    if @transaction.destroy
      redirect_to category_group_index_path(params[:category_id])
    else
      render :new
    end
  end
